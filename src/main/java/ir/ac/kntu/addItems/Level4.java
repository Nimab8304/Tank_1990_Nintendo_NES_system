...
public class Level4 {
    public static void addObjects() {
        ...
        Main.gameObjects.add(ironWall6);
        Main.gameObjects.add(ironWall7);
        Main.gameObjects.add(ironWall8);
        Main.gameObjects.add(ironWall9);
        ...
        Main.tanks.add(randomTank2);
        Main.tanks.add(randomTank3);
